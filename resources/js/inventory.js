...
const table = {
    ...
    async updateRow(id, formData) {
        ...
        cells[2].textContent = data.points_per_unit;
...
const handlers = {
    ...
    onEdit(e) {
        ...
        utils.getElement(SELECTORS.fields.editPoints).value = cells[2].textContent.trim();
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('inventory:add', handlers.onAdd);
    document.addEventListener('inventory:edit', handlers.onEdit);
    document.addEventListener('inventory:delete', handlers.onDelete);
