...
const ui = {
    ...
    createRowHTML(data) {
        return `
            <td class="py-4 px-2 text-sm text-gray-800">${data.order_id}</td>
            <td class="py-4 px-2 text-sm text-gray-800">${data.created_at}</td>
            <td class="py-4 px-2 text-sm text-gray-800">${data.customer}</td>
            ...
            <td class="py-2 px-2 text-sm text-gray-800">
                <div class="flex justify-center items-center gap-2">
                    ...
                    <button class="edit-btn text-indigo-600 hover:text-indigo-800 transition-colors" data-id="${data.id}" title="Edit">
                       <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
