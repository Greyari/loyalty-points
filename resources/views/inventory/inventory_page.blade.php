...
<div class="space-y-6 mb-6">
    <div class="flex justify-between items-start">
        <div>
            <h2 class="text-2xl sm:text-3xl lg:text-4xl font-semibold font-poppins mb-0">Product</h2>
            <p class="text-sm sm:text-base lg:text-lg font-light text-gray-500 font-poppins">Manage your product.</p>
        </div>
