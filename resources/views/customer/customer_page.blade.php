...
<div class="space-y-6 mb-6">
    <h2 class="text-2xl sm:text-3xl lg:text-4xl font-semibold font-poppins mb-0">Customer Data</h2>
    <p class="text-sm sm:text-base lg:text-lg font-light text-gray-500 font-poppins">Manage your customer data.</p>
</div>

<x-data-tables
    module="customer"
    :headers="['Name', 'Phone', 'Total Points']"
    :rows="$customers"
    onAdd="true"
    onEdit="true"
    onDelete="true" />
    ...
    <form id="createForm" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="phone"
                class="placeholder:text-gray-400 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-700 focus:border-transparent"
