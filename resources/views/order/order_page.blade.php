...
<div class="space-y-6 mb-6">
    <div class="flex justify-between items-start">
        ...
        <a href="{{ url('/orders/export-detail') }}"
        class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors flex items-center gap-2 font-poppins">
